...
| Repair strategy accuracy         | 90.0%   |
| Joint success                    | 90.0%   |
| Average rounds                   | 6.7     |
| Average tool cost                | 4.55    |
...
| diag_confound_01  | H_confounded_mixed_signals | hard         | data_quality_issue         | feature_distribution_drift | feature_patch            | human_review             | no        |        7 |    5.5 |
| diag_confound_02  | H_confounded_mixed_signals | hard         | rule_interaction_issue     | threshold_miscalibration   | rule_update              | human_review             | no        |        6 |    4.4 |
| diag_confound_03  | H_confounded_mixed_signals | hard         | attack_pattern_drift       | attack_pattern_drift       | rule_update              | rule_update              | yes       |        8 |    5.8 |
...
| H_confounded_mixed_signals |   4 | 50.0%           |       4.88 | attack_pattern_drift, data_quality_issue, rule_interaction_issue, traffic_segment_shift |

## Per Root Cause

| Root cause                 |   N | Joint success   |   Avg cost |
|----------------------------|-----|-----------------|------------|
| attack_pattern_drift       |   3 | 100.0%          |       5.8  |
| data_quality_issue         |   3 | 66.7%           |       5.37 |
| feature_distribution_drift |   2 | 100.0%          |       4.2  |
| label_delay                |   2 | 100.0%          |       2.5  |
| model_capacity_issue       |   2 | 100.0%          |       4.6  |
| rule_interaction_issue     |   3 | 66.7%           |       5.33 |
