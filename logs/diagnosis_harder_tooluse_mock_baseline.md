...
| diag_confound_01                    | A_DataIntegrity     | confounded      | data_quality_issue         | feature_distribution_drift | feature_patch            | human_review             | no     | yes       |        5 |    4.2 |
| diag_confound_02                    | D_FeedbackLoop      | confounded      | rule_interaction_issue     | threshold_miscalibration   | rule_update              | human_review             | no     | yes       |        5 |    3.8 |
| diag_confound_03                    | C_AdversarialDrift  | confounded      | attack_pattern_drift       | label_delay                | rule_update              | defer_until_label_mature | no     | yes       |        5 |    2.5 |
...
|---------------------|-----|----------------|-------------------|-----------|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A_DataIntegrity     |   6 | 66.7%          | 100.0%            | 66.7%     |       4.93 | data_quality_issue                                                                                                                                                               |
...
| C_AdversarialDrift  |   6 | 83.3%          | 100.0%            | 83.3%     |       5.25 | attack_pattern_drift                                                                                                                                                             |
| D_FeedbackLoop      |   8 | 75.0%          | 100.0%            | 75.0%     |       3.9  | label_delay, rule_interaction_issue                                                                                                                                              |
