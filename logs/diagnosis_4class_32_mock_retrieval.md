...
| Joint success                    | 87.5%   |
| Average rounds                   | 6.7     |
| Average tool cost                | 4.58    |
| Replay pass rate                 | 89.3%   |
...
| diag_confound_01                    | A_DataIntegrity     | confounded   | data_quality_issue         | feature_distribution_drift | feature_patch            | human_review             | no        |        7 |    5.5 |
| diag_confound_02                    | D_FeedbackLoop      | confounded   | rule_interaction_issue     | threshold_miscalibration   | rule_update              | human_review             | no        |        6 |    4.4 |
| diag_confound_03                    | C_AdversarialDrift  | confounded   | attack_pattern_drift       | attack_pattern_drift       | rule_update              | rule_update              | yes       |        8 |    5.8 |
...
|---------------------|-----|-----------------|------------|---------------------------------------------------------------------------------------------------|
| A_DataIntegrity     |   6 | 66.7%           |       5.15 | data_quality_issue                                                                                |
...
| C_AdversarialDrift  |   6 | 100.0%          |       5.8  | attack_pattern_drift                                                                              |
| D_FeedbackLoop      |   8 | 75.0%           |       3.98 | label_delay, rule_interaction_issue                                                               |

## Per Root Cause

| Root cause                 |   N | Joint success   |   Avg cost |
|----------------------------|-----|-----------------|------------|
| attack_pattern_drift       |   6 | 100.0%          |       5.8  |
| data_quality_issue         |   6 | 66.7%           |       5.15 |
| feature_distribution_drift |   3 | 100.0%          |       4.2  |
| label_delay                |   3 | 100.0%          |       2.5  |
| model_capacity_issue       |   3 | 100.0%          |       4.6  |
| rule_interaction_issue     |   5 | 60.0%           |       4.86 |
